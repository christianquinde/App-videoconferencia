...
#
# A simple RTP server
#  sends the output of v4l2src as VP8 encoded RTP on port 5000, RTCP is sent on
...
#VENC="vp8enc target-bitrate=350000 keyframe-max-dist=30 cpu-used=2 deadline=1 ! rtpvp8pay"
